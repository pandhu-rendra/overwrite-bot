...
{color:#00FFFF}};true]]
    ...
    **Proper use:**
    \`$getGuildVar[prefix]gstart [Time] [Winners] [Prize]\`}{color:#00FFFF}{footer:Error ~ $username[$authorID]:$authorAvatar}}]
...
$onlyClientPerms[managemessages;{newEmbed:{title:Permissons Error Bot}{description:Sorry, but I don't have permission to "Manage Messages"}{color:#00FFFF}{footer:Error ~ $username[$authorID]:$authorAvatar}}]$suppressErrors
$reply
$addTimestamp
$clientTyping`
},{
    ...
    $editMessage[$timeoutData[mid];{newEmbed:{title:The drawing is over.} {description:
        ...
        • Winners: $if[$get[random]==;No winner **(no participant)**;$get[random]]} {color:#00FFFF}};$timeoutData[cid]]
